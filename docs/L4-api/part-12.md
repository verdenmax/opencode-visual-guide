...
| `.github/VOUCHED.td` | **vouch 信任名单**（CONTRIBUTING 记载的受管理位置，首次 vouch/denounce 时自动创建）：vouched/denounced/everyone-else 三档；维护者评论 `vouch`/`denounce`/`unvouch` 管理、自动提交；denounced 的 issue/PR 自动关，专留给反复低质量 AI 贡献/灌水/恶意 | L63 |
