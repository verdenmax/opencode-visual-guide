...
<div class="cellgroup">
  ...
  <div class="cel"><b>cli/cmd/tui/</b><br>TUI code, SolidJS + opentui (L52–56)</div>
...
<p>如果你只带走一句话，那就让它是这个：<strong>opencode 之所以能在「AI agent」这个快速演化、充满不确定的领域里保持清晰，靠的不是更聪明的技巧，而是反复地「找准接缝、复用成熟、让正确省力、为未知留门」</strong>。这些智慧不属于 opencode，它们属于一切想把复杂系统做扎实的工程师——也包括正在读这本书的你。至此，全书 64 课圆满收尾。愿你带着这张地图，去读源码、去改它、去贡献，或者，去建造你自己的东西。</p>
""",
