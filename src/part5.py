...
<p>当替换真的可以进行（<span class="mono">ReplacementReady</span>）时，还有最后一道纪律要守：<strong>这次切换必须是原子的、一致的</strong>——绝不能切到一半被另一个并发操作搅乱。这就是 <span class="mono">fence</span>（栅栏）和那个 <span class="mono">revision</span> 版本号的活。</p>
