...
<div class="trace">
  <div class="t-row"><span class="t-num">content 怎么定?</span><span class="t-txt">工具给了 <span class="mono">toModelOutput</span>？→ 用它渲染成 <span class="mono">text</span>/<span class="mono">file</span> 列表</span></div>
  <div class="t-row"><span class="t-num">否，是字符串?</span><span class="t-txt">→ 直接把这串字符当文本给模型（简单工具零负担）</span></div>
  <div class="t-row"><span class="t-num">否则</span><span class="t-txt">→ content 为空 <span class="mono">[]</span>（结构化结果照样进 <span class="mono">structured</span> 归档）</span></div>
</div>
...
<div class="trace">
  <div class="t-row"><span class="t-num">how is content set?</span><span class="t-txt">tool gave <span class="mono">toModelOutput</span>? → use it to render a <span class="mono">text</span>/<span class="mono">file</span> list</span></div>
  <div class="t-row"><span class="t-num">no, is it a string?</span><span class="t-txt">→ show that string as text (zero burden for simple tools)</span></div>
  <div class="t-row"><span class="t-num">otherwise</span><span class="t-txt">→ content is empty <span class="mono">[]</span> (the structured result still files into <span class="mono">structured</span>)</span></div>
</div>
